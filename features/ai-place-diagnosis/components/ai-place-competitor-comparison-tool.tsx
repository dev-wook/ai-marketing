...
function PlaceSearchColumn({
  ...
  return (
    <section className="grid content-start gap-3 rounded-md border border-white/10 bg-white/[0.035] p-3">
      <form onSubmit={onSearch}>
        <label className="mb-2 block text-xs font-black uppercase tracking-[0.12em] text-cyan-200/75">
          {label}
        </label>
        <div className="grid gap-2 sm:grid-cols-[1fr_auto]">
          ...
          <button
            type="submit"
            disabled={!canSearch}
            className="inline-flex min-h-13 items-center justify-center gap-2 rounded-md border border-cyan-300/30 bg-cyan-300/12 px-5 text-sm font-black text-cyan-50 transition hover:border-cyan-200/60 hover:bg-cyan-300/18 disabled:cursor-not-allowed disabled:opacity-45"
          >
