export const aiPlaceRubricVersion = 'ai-place-rubric-v3'
export const aiPlaceScorerVersion = 'ai-place-scorer-v2'
...
export const aiPlaceDiagnosisPromptVersion = 'ai-place-diagnosis-prompt-v3'
